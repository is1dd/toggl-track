    ...
    return (
        ...
        <HStack align={'flex-start'} pl={'11rem !important'} border={'1px solid transparent'} w={'99.5% !important'}>
            ...
            <VStack w={'100%'} background={'white !important'}>
                <HStack position={'sticky'} top={'0.2rem'} background={'white'} boxShadow={'0px 10px 15px -15px #111'} gap={'0.8rem'} className='addProject' w={'100%'} p={'0.7rem 0rem'}  >
                ...
                <VStack position={'sticky'} mt={'0rem !important'} top={'5.3rem'} pt={'1.5rem'} pl={'0.5rem'} pb={'1.5rem'} fontSize={'0.8rem'} pr={'2rem'} justify={'space-between'} bg={'#fef9f7'} w={'100%'}>
                    ...
                    <HStack w={'100%'}>
                        ...
                        <VStack align={'flex-start'} w={'35%'}>
                            <Text fontSize={'1rem'} color={'rgb(229, 124, 216)'}>group</Text>
                            <Divider background={'rgb(229, 124, 216)'} borderRadius={'5px'} height={'3.8px'} w={'100%'} />

                        </VStack>
                    </HStack>
                </VStack>
                <HStack position={'sticky'} top={'13.55rem'} background={'white'} justify={'space-between'} m={'0rem !important'} w={'100%'} border={'1px solid #ece5e5 '}>
